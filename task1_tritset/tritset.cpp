...
void TritSet::shrink() //сжать тритсет до размера послед. устан. трита
{
	size_t len = tritsToBytes(length())+1;
...
void TritSet::setTrit(Trit value, size_t idx)
{
	...
	storage_[tritsToBytes(idx)] = word;
}
